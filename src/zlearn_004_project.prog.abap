...
TRY.
* URL
    DATA(lv_url) = |https://world.openfoodfacts.org/api/v0/product/3017620422003/|.
...
* HTTP Body als Character-Daten
        ...
        WRITE: / 'Produktname:', ls_name,
               / 'EAN-Code:', ls_code,
               / 'CO2-Verbrauch:', ls_co2, 'g CO2 pro 1g'.
      ENDIF.
